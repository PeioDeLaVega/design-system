...
export const setStateMemory = ({ message, messageType = MessageTypes.error }) => (prevState) => ({
    ...prevState,
    memory: {
        message,
        messageType,
...
export const setStateOnFocus = ({ message, messageType = MessageTypes.error }) => (prevState) => ({
    ...prevState,
    hasFocus: true,
...
export const addPropsClone = ({ message, messageType, classModifier, wrapper, child, name, getMessageClassModifierFn = FormClassManager.getMessageClassModifier, eventWrapperFn = eventWrapper, }) => {
